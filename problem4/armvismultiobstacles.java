...
public class armvismultiobstacles extends JPanel {
	...
	//{x1, x2, y1, y2}
	private double[][] obstacles = {{140,185,250,100},{450,320,100,50},{145,310,50,50}};//{{450, 550, 320, 370}, {145, 195, 310, 360}, {140, 350, 185, 250}};
	...
	public void paintComponent(Graphics g) {
		...
		for (int j = 0; j < obstacles.length; j++){
			drawEdge(obstacles[j][0],obstacles[j][0],obstacles[j][1]+ obstacles[j][3],obstacles[j][1],g);
			drawEdge(obstacles[j][0]+obstacles[j][2],obstacles[j][0]+obstacles[j][2],obstacles[j][1] + obstacles[j][3],obstacles[j][1],g);
			drawEdge(obstacles[j][0],obstacles[j][0]+ obstacles[j][2],obstacles[j][1],obstacles[j][1],g);
			drawEdge(obstacles[j][0]+obstacles[j][2],obstacles[j][0],obstacles[j][1] + obstacles[j][3],obstacles[j][3] + obstacles[j][1],g);
		}
		if (theTree != null) {
